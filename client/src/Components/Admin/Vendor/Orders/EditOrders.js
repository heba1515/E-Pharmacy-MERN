                        ...
                        {orders.map((order, index) => (
                          <div key={order.number}>
                            ...
                            <div className="bg-gray-50 rounded-lg py-6 px-4 sm:px-6 sm:flex sm:items-center sm:justify-between sm:space-x-6 lg:space-x-8">
                              ...
                              <select
                                className={`block w-52 font-semibold py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 ${order.status === "Pending"
                                    ? "text-yellow-900"
